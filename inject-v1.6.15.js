'use strict';
const fs=require('fs');
const MAX_RANK=5000,MAX_ADD=100,VERSION='1.6.15';
...
const candidates=rows(require('./pack-next-v1.6.15.js'));
...
require('child_process').execFileSync(process.execPath,['inject-v1.6.16.js',file],{stdio:'inherit'});
