...
const cards=require('./pack-1301-1400-v1.4.13.js');
...
if(new Set(ranks).size!==100)throw new Error('duplicate Rank in v1.4.13');
for(let r=1301;r<=1400;r++)if(!ranks.includes(r))throw new Error(`missing Rank ${r}`);
...
const dupMin=Number(process.env.DUP_MIN||1301),dupMax=Number(process.env.DUP_MAX||1400);
...
html=html.replaceAll('const APP_VERSION="1.4.12";','const APP_VERSION="1.4.13";')
         .replaceAll('FSRS · v1.4.12','FSRS · v1.4.13')
         .replaceAll('Web公開版 v1.4.12','Web公開版 v1.4.13');
html=html.replaceAll('教材化済み：Rank 1–1300','教材化済み：Rank 1–1400')
         .replaceAll('Rank 1–1300（うちRank 40','Rank 1–1400（うちRank 40');
...
console.log('AUDIT OK: Rank 1301-1400 mapped; 100 cards; all example tokens explained; TTS/translation/grammar links valid; duplicate examples absent; controls/events/storage/PACK invariants preserved; v1.4.13');
