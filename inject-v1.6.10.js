'use strict';
const fs=require('fs');
const MAX_RANK=5000,MAX_ADD=100,VERSION='1.6.10';
...
const candidates=rows(require('./pack-next-v1.6.10.js'));
...
const COMMON={오늘:'今日',내일:'明日',이번:'今回・今度の',다음:'次の',주:'週',달:'月',시간:'時間',조금:'少し',너무:'とても・あまりに',잘:'よく・うまく',바로:'すぐ',먼저:'先に',다시:'再び',꼭:'必ず',아직:'まだ',벌써:'もう・すでに',보통:'普通・通常',정도:'程度',하나:'一つ',이름:'名前',문자:'SMS・文字',앱:'アプリ',휴대폰:'携帯電話',카드:'カード',여행:'旅行',공항:'空港',회사:'会社',병원:'病院',고객센터:'カスタマーセンター',물:'水',고기:'肉',옷:'服',밥:'ご飯',약:'薬',서류:'書類',상품:'商品',물건:'物・品物',짐:'荷物'};
...
require('child_process').execFileSync(process.execPath,['inject-v1.6.11.js',file],{stdio:'inherit'});
