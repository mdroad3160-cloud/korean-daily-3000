...
if(new Set(ranks).size!==100)throw new Error('duplicate Rank in v1.4.10');
for(let r=1001;r<=1100;r++)if(!ranks.includes(r))throw new Error(`missing Rank ${r}`);
...
html=html.replaceAll('const APP_VERSION="1.4.9";','const APP_VERSION="1.4.10";')
         .replaceAll('FSRS · v1.4.9','FSRS · v1.4.10')
         .replaceAll('Web公開版 v1.4.9','Web公開版 v1.4.10');
html=html.replaceAll('教材化済み：Rank 1–1000','教材化済み：Rank 1–1100')
         .replaceAll('Rank 1–1000（うちRank 40','Rank 1–1100（うちRank 40');
...
console.log('AUDIT OK: Rank 1001-1100 mapped; 100 cards; all example tokens explained; TTS/translation/grammar links valid; duplicate examples absent; controls/events/storage/PACK invariants preserved; v1.4.10');
