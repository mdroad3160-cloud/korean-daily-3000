...
const dupMin=Number(process.env.DUP_MIN||1001),dupMax=Number(process.env.DUP_MAX||1100);
...
html=html.replaceAll('const APP_VERSION="1.4.9";','const APP_VERSION="1.4.10";').replaceAll('FSRS · v1.4.9','FSRS · v1.4.10').replaceAll('Web公開版 v1.4.9','Web公開版 v1.4.10');
html=html.replaceAll('教材化済み：Rank 1–1000','教材化済み：Rank 1–1100').replaceAll('Rank 1–1000（うちRank 40','Rank 1–1100（うちRank 40');
...
for(const s of ['const STORAGE_KEY="korean-daily-3000-state-v01";','const SETTINGS_KEY="korean-daily-3000-settings-v01";','function normalizeExampleToken(','globalThis.__KOREAN_PENDING_PACKS','"rank":1100,"word":"돌아보다"','const APP_VERSION="1.4.10";'])if(!html.includes(s))throw new Error(`required invariant missing: ${s}`);
