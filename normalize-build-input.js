...
for(const f of ['pack-2701-2800-v1.4.27.js','inject-v1.4.27.js','finalize-v1.4.27.js','pack-3001-3100-v1.5.0.js','inject-v1.5.0.js','pack-3101-3200-v1.5.1.js','inject-v1.5.1.js','pack-3201-3300-v1.5.2.js','inject-v1.5.2.js'])cp.execFileSync(process.execPath,['--check',f],{stdio:'inherit'});
...
fs.writeFileSync(output,s);console.log('Normalized build source declarations; Daily5000 Rank 3001-3300 chain prepared');
